...
function render(variablesz = {}) {
  ...
  if (variablesz.socialMediaPosition === "right") variablesz.socialMediaPosition = "right";
  if (variablesz.socialMediaPosition === "left") variablesz.socialMediaPosition = "left";
